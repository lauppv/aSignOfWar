...
import { getAllianceProfile, uploadAllianceAvatar, type AllianceProfile } from "@/features/alliance/api/alliance";
...
import { ACCESS_LABEL, ACCESS_COLOR } from "@/shared/lib/labels";
