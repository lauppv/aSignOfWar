...
import { recruitUnits, cancelRecruitmentOrder } from "@/features/city/api/city";
import { UNITS, getRecruitmentTime, getHousingCapacity as getMaxPopulation } from "@shared/gameConfig.ts";
import { getBuildingLevel, fmtDuration, computePopulation } from "@/features/city/lib/cityHelpers";
import { GAME_SPEED } from "@/shared/lib/gameSpeed";
import { UNIT_DISPLAY, UNIT_ORDER, BUILDING_DESCRIPTION } from "@/shared/lib/labels";
