...
import type { MapCity, CityOverview, UnitName, OutgoingCommand } from "@/shared/types";
import { sendCommand, getCityCommands, withdrawStationedSupport, cancelCommand, type CommandType } from "@/features/city/api/command";
...
import { UNIT_DISPLAY, UNIT_ORDER, BUILDING_DISPLAY, BUILDING_ORDER, CMD_COLORS, CMD_LABEL } from "@/shared/lib/labels";
